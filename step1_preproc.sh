...
session=$2
subj_dir=$3
#skyra_dir=/scratch/amennen/FromConquestArchive
skyra_dir=/jukebox/dicom/conquest/Skyra-AWP45031/NormaL/2020 #this is where your files get sent to from the scanner
# for arhived data, temporary scratch dir
#skyra_dir=/scratch/amennen/FromConquestArchive #this is where your files get sent to from the scanner
