...
fmri_dir = '/jukebox/norman/amennen/RT_prettymouth/data'
raw_dir = join(fmri_dir, 'conquest') #folders copied from conquest
bids_dir = join(fmri_dir, 'bids', 'Norman', 'Mennen', '5516_greenEyes') 
...
run("singularity exec --cleanenv --bind {0}:/home "
    ...
    "heudiconv -f reproin --subject {2} --ses {3} --bids --locator /home/bids/Norman/Mennen/5516_greenEyes --files "
